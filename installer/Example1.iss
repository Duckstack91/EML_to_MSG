...
Source: "EML_to_MSGIcon.ico"; DestDir: "{app}"; Flags: onlyifdoesntexist
; Konfigurationsdatei
...
Name: "{group}\EML_to_MSG"; Filename: "{app}\Eml_to_Msg.exe"; IconFilename: "{app}\EML_to_MSGIcon.ico"
; Desktop-Verknüpfung
Name: "{commondesktop}\EML_to_MSG"; Filename: "{app}\Eml_to_Msg.exe"; IconFilename: "{app}\EML_to_MSGIcon.ico"
